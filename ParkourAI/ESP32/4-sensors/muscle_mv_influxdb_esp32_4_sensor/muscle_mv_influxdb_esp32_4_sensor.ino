...
#define INFLUXDB_TOKEN "5O8UT2pNQy4KPByHgdRkAJF_pEJSVyut29puYUNpA-dv5ns6wm9I10M5z6uI6f7ZDblIYBzJgUxlpfPeJWiUxA=="
...
void loop() {
  ...
  float sensorValue3 = analogRead(35);
  float sensorValue4 = analogRead(34);
  

  float millivolt1 = (sensorValue1/1023)*5;
  float millivolt2 = (sensorValue2/1023)*5;
  float millivolt3 = (sensorValue3/1023)*5;
  float millivolt4 = (sensorValue4/1023)*5;
  ...
  Serial.print(millivolt3*1000);
  Serial.println(" mV");
  Serial.println("");

  Serial.print("Voltage 4: ");
  Serial.print(millivolt4*1000);
  Serial.println(" mV");
  Serial.println("");
  ...
  sensor.addField("analog 3", sensorValue3);
  sensor.addField("voltage 3", millivolt3*1000);

  sensor.addField("analog 4", sensorValue4);
  sensor.addField("voltage 4", millivolt2*1000);
